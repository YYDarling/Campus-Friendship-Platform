    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 280px; display: flex; padding-left: 30px">
        <div style="width: 50px">
          <img src="../assets/logo1.png" alt="" style="width: 40px; position: relative; top: 10px; right: 0">
        </div>
        <div style="flex: 1; font-size: 20px; color: orangered; font-weight: bold">前台设计</div>
      </div>
      <div style="flex: 1">
